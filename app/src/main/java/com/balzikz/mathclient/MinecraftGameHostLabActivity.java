...
public final class MinecraftGameHostLabActivity extends Activity {
    private static final int CREATE_TOMBSTONE_FILE = 393;
    ...
    protected void onCreate(Bundle state) {
        ...
        launch.setText("ЗАПУСТИТЬ STAGE 3.9.3 GAME HOST");
    ...
    private String captureTrace(ApplicationExitInfo exit) {
        ...
        try (InputStream input = exit.getTraceInputStream()) {
            ...
            File target = new File(getCacheDir(), "stage-3.9.3-native-tombstone.pb");
    ...
    private void chooseTombstoneDestination() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE,
                "math-stage393-tombstone-" + tombstoneTimestamp + ".pb");
